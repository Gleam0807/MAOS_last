...
<c:url var="getBoardListURL" value="/workflow/workFlow2"></c:url>
...
function fn_prev(page, range, rangeSize, searchType, keyword) {
		...
		var range = range - 1;
		var url = "${pageContext.request.contextPath}/workflow/workFlow2";
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.html">설정</a>
            ...
            <div class="sidebar-heading">
             ...
             <li class="nav-item">
                <a class="nav-link" href="workflow/workFlow2">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-6">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">워크플로우</h6>
                                </div>
                                <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
										...
										<tr>
											...
											<td><a href='/read?applyid=${boardVO.applyid}'>${boardVO.title}</a></td>
											<td>${boardVO.userid}</td>
											<td>${boardVO.category}</td>
											<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${boardVO.writedate}" /></td>
											<td>${boardVO.category}</td>
										</tr>
										</c:forEach>
                                </table>
