                ...
                <div class="row">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="table-responsive">
                               <form action ="noticeRegist" method="get">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        ...
                                        <c:forEach items="${noticeBoardListAll}" var="boardVO">
										<tr>
											<td>${boardVO.noticeid}</td>
											<td><a href='/noticeRead?noticeid=${boardVO.noticeid}'>${boardVO.title}</a></td>
											<td>${boardVO.name}</td>
