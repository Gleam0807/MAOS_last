    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <img src="resources/admin/img/mainlogo.png" width="100px" height="80px">
               	<div class="sidebar-brand-text mx-3">MAOS</div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">쉬는 날
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
									...
									<tr>
								       <p align="left"><td><img src="resources/admin/img/company.png">${boardVO.byear}</td></p>
								       <p align="left"><td><img src="resources/admin/img/phone.png">${boardVO.btell}</td></p>
								       <p align="left"><td><img src="resources/admin/img/business.png">${boardVO.bnum}</td></p>
								       <p align="left"><td><img src="resources/admin/img/address.png">${boardVO.badd}</td></p>
									</tr>
									</c:forEach>
                                    </p>
                                    ...
                                    <!-- <a target="_blank" rel="nofollow" href="https://undraw.co/">회사소개 수정하기 &rarr;</a> -->
                                </div>
                            </div>
