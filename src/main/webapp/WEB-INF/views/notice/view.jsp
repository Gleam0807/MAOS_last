...
<div class="jumbotron container">
  ...
  <p class="display-4" style="text-align:right"><fmt:formatDate value="${view.writeDate}" pattern="yyyy-MM-dd" /></p>
  <hr class="my-4">
  <p>${view.content}</p>
  <p class="lead">
    <a class="btn btn-primary btn-sm" href="/notice/list?num=1" role="button">목록</a>
  </p>
   <sec:authorize access="hasRole('ROLE_MEMBER,ROLE_ADMIN')">
	<div style="float:right">
		<a href="/notice/modify?noticeid=${view.noticeid}" role="button" class="btn btn-info btn-sm" >게시물 수정</a> 
		<a href="/notice/delete?noticeid=${view.noticeid}" role="button" class="btn btn-info btn-sm">게시물 삭제</a>
	</div>
</sec:authorize>
</div>
